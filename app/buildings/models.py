...
class AgencesDeVoyagesFontPoint(models.Model):
    ...
    coord_x = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    coord_y = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class BacsFontPoint(models.Model):
    ...
    cordx = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    cordy = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class BouchesIncendiesYdeCustomPoint(models.Model):
    ...
    insertion = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    insertio0 = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    insertio1 = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class CitesMunicipalesCuyPoint(models.Model):
    geom = models.PointField(srid=32632, blank=True, null=True)
    n_field = models.DecimalField(db_column='n_', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed because it ended with '_'.
    designatio = models.CharField(max_length=24, blank=True, null=True)
    sup = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    estim_e_field = models.DecimalField(db_column='estim�e__', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed to remove unsuitable characters. Field renamed because it contained more than one '_' in a row. Field renamed because it ended with '_'.
    age_utile = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    actualisee = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    neuf_au_m_field = models.DecimalField(db_column='neuf_au_m�', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    actualis_e = models.DecimalField(db_column='actualis�e', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed to remove unsuitable characters.
    field_field = models.DecimalField(db_column='___', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed because it contained more than one '_' in a row. Field renamed because it started with '_'. Field renamed because it ended with '_'.
...
class EspaceVertEllipse(models.Model):
    ...
    etat = models.CharField(max_length=20, blank=True, null=True)
    superficie = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    commune = models.CharField(max_length=10, blank=True, null=True)
...
class HussiersYdeCustomPoint(models.Model):
    geom = models.PointField(srid=32632, blank=True, null=True)
    num_ro = models.DecimalField(db_column='num�ro', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed to remove unsuitable characters.
...
class LigneBusProjetPolyline(models.Model):
    ...
    lineaire = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class LimitesDesCommunesYdeRegion(models.Model):
    ...
    malades = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    pourcentag = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class MarchesCuyPoint(models.Model):
    ...
    quartier = models.CharField(max_length=20, blank=True, null=True)
    superficie = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    age_util = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    cptoire = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    boutique = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    commer_ant = models.DecimalField(db_column='commer�ant', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed to remove unsuitable characters.
    hangard = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    principale = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class ParkingsCuy2007Polyline(models.Model):
    ...
    rue = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
    field_total = models.DecimalField(db_column='_total', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed because it started with '_'.
    field_reserv_field = models.DecimalField(db_column='_reserv�', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed to remove unsuitable characters. Field renamed because it started with '_'. Field renamed because it ended with '_'.
...
class ParkingsCuyPolyline(models.Model):
    ...
    parking = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class QuartierRegion(models.Model):
    ...
    quartier = models.CharField(max_length=21, blank=True, null=True)
    arrondisse = models.CharField(max_length=30, blank=True, null=True)
    secondaire = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class RadioYaoundeCustomPoint(models.Model):
    ...
    t_l_phone = models.DecimalField(db_column='t�l�phone', max_digits=65535, decimal_places=65535, blank=True, null=True)  # Field renamed to remove unsuitable characters.
    postale = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class RouteEnProjetPolyline(models.Model):
    ...
    lineraire = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
...
class ZoneAdressageRegion(models.Model):
    ...
    super = models.DecimalField(max_digits=65535, decimal_places=65535, blank=True, null=True)
